...
public class DummyDataProvider implements MovieDataSource {
    ...
    private void initializeData() {
        // Create dummy movies
        // Using reliable placeholder images since TMDB URLs might be expiring or
        // blocking direct access without API key
        Movie m1 = new Movie("1", "Stranger Things",
                ...
                "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", "2016", "9.5");
        ...
        Movie m2 = new Movie("2", "The Crown",
                ...
                "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4", "2016", "8.7");
        ...
        Movie m3 = new Movie("3", "Breaking Bad",
                ...
                "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", "2008", "9.5");
